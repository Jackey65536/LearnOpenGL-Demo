...
namespace Ch04 {
    namespace CubeMapsEvnMapping {
        ...
        int main(int argc, char * argv[]) {
            ...
            GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Cube Maps Environment Mapping", NULL, NULL);
            if (!window) {
            ...
            Shader shader("resources/shaders/cubemaps_env.vs", "resources/shaders/cubemaps_env.fs");
