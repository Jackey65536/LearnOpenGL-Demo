...
namespace Ch04 {
    namespace BlendingSorted {
        ...
        int main(int argc, char * argv[]) {
            ...
            GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Blending Sorted", NULL, NULL);
            if (!window) {
            ...
            Shader shader("resources/shaders/blending.vs", "resources/shaders/blending_sort.fs");
            float cubeVertices[] = {
