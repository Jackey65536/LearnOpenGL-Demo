...
namespace Ch02 {
    namespace MultipleLight {
        ...
        int main(int argc, char * argv[]) {
            ...
            GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Multiple Light", NULL, NULL);
            if (!window) {
            ...
            do {
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    lightingShader.setVec3(s + std::to_string(i) + std::string("].position").c_str(), pointLightPositions[i]);
                    lightingShader.setVec3(s + std::to_string(i) + std::string("].ambient").c_str(), 0.05f, 0.05f, 0.05f);
                    lightingShader.setVec3(s + std::to_string(i) + std::string("].diffuse").c_str(), 0.8f, 0.8f, 0.8f);
                    lightingShader.setVec3(s + std::to_string(i) + std::string("].specular").c_str(), 1.0f, 1.0f, 1.0f);
                    lightingShader.setFloat(s + std::to_string(i) + std::string("].constant").c_str(), 1.0f);
                    lightingShader.setFloat(s + std::to_string(i) + std::string("].linear").c_str(), 0.09);
                    lightingShader.setFloat(s + std::to_string(i) + std::string("].quadratic").c_str(), 0.032);
                }
