...
namespace Ch02 {
    namespace LightingMapsEmission {
        ...
        int main(int argc, char * argv[]) {
            ...
            GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Lighting Maps Emission", NULL, NULL);
            if (!window) {
            ...
            Shader lightingShader("resources/shaders/lighting_maps.vs", "resources/shaders/lighting_maps_emission.fs");
