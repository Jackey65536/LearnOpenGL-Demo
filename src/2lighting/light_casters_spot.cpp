...
namespace Ch02 {
    namespace LightCastersSpot {
        ...
        int main(int argc, char * argv[]) {
            ...
            GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Light Casters Spot", NULL, NULL);
            if (!window) {
            ...
            Shader lightingShader("resources/shaders/light_caster.vs", "resources/shaders/light_caster_spot.fs");
